      ...
      <div className="w-full h-[30rem] flex justify-center items-center relative">
        ...
        <div className=" flex justify-center items-center relative">
          ...
          <h1 className="text-5xl max-[590px]:text-4xl max-[400px]:text-[2rem] w-[80%] max-[590px]:w-[95%] text-white font-sans font-bold shadow-inner">
            JOIN <span className="text-black">FITNESS</span><span className="text-red-800">HUB</span> WHERE EVERY <span className="text-black">WORKOUT</span> IS STEP TOWARD <span className="text-red-800">GEARTNESS</span>.
          </h1>
          </center>
        </div>
      </div>
